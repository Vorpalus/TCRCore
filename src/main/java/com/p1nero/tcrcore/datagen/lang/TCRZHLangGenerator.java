...
public class TCRZHLangGenerator extends TCRLangProvider {
    ...
    protected void addTranslations() {
        ...
        this.addDialog(TCREntities.GUIDER.get(), 4, "看来阁下真是预言中的天外勇者！§b风暴之火种§f散落在天空岛的铁傀儡身上。§6烈焰之种§f需从龙之塔的火龙口中夺回。§3深渊之眼§f需在[隐秘水湾]底下Bulldrogious夺回。§2§f需前往寒冰迷宫奏响§6[号角]§f询问可妮莉娅(Cornelia)船长的灵魂。§e沙漠之眼§f需从[海底神殿]的§6[远古守卫者]§f手中夺回！我已将他们散落的位置标注在地图之上了，小神便在此地等候，待你点亮所有火种，吾便启动黑潮清洗仪式！");

...
public class BanPortalScreenHandler {
    ...
    public static void onGenerateZH(TCRLangProvider generator) {
        ...
        generator.addScreenAns(name, 0, "（传送门并没有如期出现，看来作者并不需要你进入这两个维度）");
    ...
    public static void onGenerateEN(TCRLangProvider generator) {
        ...
        generator.addScreenAns(name, 0, "(The portal did not appear as expected. It seems the author doesn't require you to enter these two dimensions.)");
